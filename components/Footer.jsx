    ...
    <footer className="relative z-10 mt-32 border-t border-gold/15">
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="font-display text-3xl text-shimmer">Maison Lumière</div>
          ...
          <div className="max-w-sm">
            <h4 className="uppercase-spaced text-xs text-gold/70 mt-8 mb-1">The Inner Circle</h4>
            <p className="text-taupe text-sm">Early access to new compositions & private events.</p>
            <NewsletterForm />
          </div>
        </div>
        <div>
